 ...
 * @flow
    ...
    Desafio: fazer um criador de meme, que a imgem altera, e quando não for o meme do "mimi", 
    a escrita deve ser normal, sem trocar as vogais pelo i
 */
...
export default class App extends Component<Props> {
  constructor (props){
    ...
    this.escrever = this.escrever.bind(this);//para que o escrever consiga acessar o state e alterar a escrita 
                                            // de acordo com o que foi escrito no input
  }
  ...
  render() {
    return (
      <View style={styles.body}>
        <View>
          <Text style={styles.titulo}>Criador de Memes - Mimimi</Text>
        </View>
        ...
        <View styles={styles.area}>
          ...
          <Image style={styles.guri} source={require('./images/mimimi.png')} />
